...
class StateManager:
    ...
    def create_state(self, all_info, this_veh, obs_clip=False, padding_size=2):
        ...
        valid_path_matrix, forbidden_path_matrix = \
            self.create_path_matrix(layout, veh_loaded, current_place, target_place, self.occupied_place)
        other_agv_matrix = self.create_other_matrix(layout, valid_path_matrix, self.occupied_place, target_place)
        ...
        if obs_clip:
            ...
            # print(self.occupied_place)
            # print("oc:",occupied_place)
    ...
    def create_path_matrix(self, layout, veh_loaded, current_place, target_place, occupied_place):
        ...
        # Xử lý thêm điểm robot chuyển thành điểm cấm
